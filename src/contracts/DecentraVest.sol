...
contract DecentraVest {
    ...
    function joinAsTrader(uint256 _investorProfitPercent) external {
    ...
    function joinAsInvestor() external {
        require(traders[msg.sender].user == address(0), "Already registered as trader");
        require(investors[msg.sender].user == address(0), "Already registered as investor");
    ...
    */
    function approveExitEther(uint256 _investmentId, address _investorAddress) external payable {
