...
const decorateInvestment = (investment) => {
  ...
  return {
    ...
    grossProfit: new BigNumber(investment.grossProfit),
...
const reduceInvestment = (investment) => {
  ...
  return {
    ...
    grossProfit: investment.grossProfit.toString(),
    investorProfit: investment.investorProfit.toString(),
    traderProfit: investment.traderProfit.toString()
  }
}
