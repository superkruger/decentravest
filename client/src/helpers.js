...
export const INVESTMENT_STATE_INVESTED = 0
export const INVESTMENT_STATE_STOPPED = 1
export const INVESTMENT_STATE_EXITREQUESTED_INVESTOR = 2
export const INVESTMENT_STATE_EXITREQUESTED_TRADER = 3
export const INVESTMENT_STATE_EXITAPPROVED = 4
